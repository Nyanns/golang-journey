...
const CategoryIcon = ({ name }) => {
  switch (name) {
    ...
    case 'QA & Automated Testing (SDET)':
      return (
        <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="text-accent">
    ...
    case 'Defensive Security & Cryptography':
      return (
        <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="text-accent">
    ...
    case 'Technical SEO & Search Intelligence':
      return (
        <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="text-accent">
    ...
    <section id="stack" className="px-4 py-8 md:px-0">
      ...
      <div className="mb-8 flex items-center justify-between">
        <h2 className="flex items-center gap-3 text-2xl font-semibold md:text-3xl">
          ...
          <span style={{ color: 'var(--ctp-text)' }}>Skills &amp; Technologies</span>
        </h2>
      </div>
