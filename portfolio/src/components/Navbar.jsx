      ...
      >
        ...
        <nav className="hidden items-center space-x-1 md:flex">
          ...
          <a
            ...
            className="inline-flex items-center gap-1.5 rounded px-3 py-2 text-sm font-medium transition-colors duration-150 hover:text-accent"
            style={{ color: 'var(--ctp-text)' }}
              ...
              <ul className="space-y-2">
                ...
                <li>
                  <a
                    ...
                    target="_blank"
                    rel="noopener noreferrer"
                    className="flex items-center justify-between rounded p-2 text-sm transition-colors hover:text-accent"
                    style={{ color: 'var(--ctp-text)' }}
                  >
                    <span>{t('nav.resume')}</span>
